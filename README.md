...
I learned how to change images depending on screen size.
So I have two images which are called pattern divider, one is user for desktop and
second one is used for mobile devices. They will changed depending what screen is active.

### Continued development

I'll keep practising React, so I can make even bigger projects and pripare myself for it.
...
I'm also thankful for amazing udemy courses which helped me a lot.
